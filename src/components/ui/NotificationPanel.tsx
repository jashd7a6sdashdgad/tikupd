  ...
  return (
    <div className={cn('space-y-4', className)}>
      ...
      <div className="flex items-center justify-between">
        <div className="flex items-center gap-3">
          <div className="p-2 bg-gradient-to-br from-blue-500 to-purple-600 rounded-xl shadow-lg">
            <Bell className="w-5 h-5 text-black font-bold" />
          </div>
          <div>
      ...
      <div className="pt-4 border-t border-white/20">
        <button className="w-full px-4 py-2 text-sm font-medium text-black font-bold bg-gradient-to-r from-blue-500 to-purple-600 hover:from-blue-600 hover:to-purple-700 rounded-2xl transition-all duration-300 hover:scale-105 hover:shadow-lg">
